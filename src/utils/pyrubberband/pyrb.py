...
# NOTE: This is the original pyrubberband package with one custom addition:
# `pitch_shift_2` applies a pitch shift using a frequency ratio instead of semitones.
...
### CUSTOM METHOD ADDED 07-04-2026
def pitch_shift_2(y, sr, ratio, rbargs=None):
    '''Apply a pitch shift to an audio time series using a frequency
    ...
    rbargs.setdefault('--frequency', ratio)
